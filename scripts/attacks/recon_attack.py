#!/usr/bin/env python3
"""
Reconnaissance attack script - Phase 1, Category 1.
Runs nmap scans against the victim, varying intensity/timing per session.
...
CLOUD = "aws"
MAX_SCAN_SECONDS = 120  # hard cap so a blocked scan can't hang forever
...
def run_scan(session_num, scan_type, nmap_args, severity):
    ...
    try:
        ...
        print(f"[{session_id}] TIMED OUT after {MAX_SCAN_SECONDS}s (likely blocked mid-scan)")
